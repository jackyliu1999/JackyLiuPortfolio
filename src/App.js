...
import musicCatalyst from './Components/images/musicCatalyst.png'
import chatJS from './Components/images/ChatJS.png'
import RuneterraBot from './Components/images/RuneterraBot.png'
import Decoy from './Components/images/Decoy.jpg'
import Chowdown from './Components/images/Chowdown.png'
import GitLogo from './Components/images/gitLogo.png'
import infoIcon from './Components/images/infoIcon.png'
import ChowDownDemo2 from './Components/images/Chowdown2.png'
import ChowDownDemo3 from './Components/images/Chowdown3.jpg'
import ChowDownDemo4 from './Components/images/Chowdown4.jpg'
import ChowDownDemo5 from './Components/images/Chowdown5.jpg'
import Decoy2 from './Components/images/Decoy2.jpg'
import Decoy3 from './Components/images/Decoy3.jpg'
import Decoy4 from './Components/images/Decoy4.jpg'
import NotesToText1 from './Components/images/NotesToText1.PNG'
import NotesToText2 from './Components/images/NotesToText2.PNG'
import cverseCommands from './Components/images/cverseCommands.PNG'
import cversestatsCanada from './Components/images/cversestatsCanada.PNG'
import cverseReddit from './Components/images/cverseReddit.PNG'
import cverseNews from './Components/images/cverseNews.PNG'
import runeterrabot1 from './Components/images/runeterrabot1.JPG'
import runeterrabot2 from './Components/images/runeterrabot2.JPG'
import runeterrabot3 from './Components/images/runeterrabot3.JPG'
...
function App() {
  ...
  return (
    <div className="App">
      <TitlePage />
      {/* Header: Home, About, Skills, Projects, Contact */}
      <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
          <h1 class="logo"><a href="index.html">Jacky<span>.</span></a></h1>
      ...
      <section id="projects" class="projects">
        <div class="container">
          <div class="section-title">
            <h2 style={{ color: "white", textAlign: "center" }}> <b>Personal Projects</b></h2>
          </div>
          <div class="row">
          ...
          <div class="section-title">
            <h2 style={{ color: "white", textAlign: "center" }}> <b>Hackathons</b></h2>
          </div>
      ...
      <section class="projects2 spad">
        <div class="container">
          <div class="row">
            <div class="col-lg-4">
              <div class="projects2__title">
                <div class="section-title">
                  <h2 style={{ color: "#e6f1ff" }}>Other Notable Projects</h2>
                </div>
                <p style={{ color: "#ccd6f6" }}>A compressed list of projects that I've worked on.<br /> <br /> Click on the information icon for more information about the project.<br /><br />Click on the GitHub icon to be redirected to the GitHub repository.</p>
              </div>
            </div>
            <div class="col-lg-8">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="projects2__item">
                    <a href="https://github.com/jackyliu1999/Desktop-Cleaner"> <img src={GitLogo} alt="" /></a>
                                &nbsp; <img src={infoIcon} onClick={handleshow7Show} alt="" />
                    <a href="https://github.com/jackyliu1999/Desktop-Cleaner"> <h4 style={{ color: "#e6f1ff" }}>Desktop Cleaner</h4></a>
                    <p style={{ color: "white" }}>Desktop cleaner is a Python-based automation script that sorts folders based on file type (images, documents, spreadsheets, installers, music, videos) into a user inputted directory.</p>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="projects2__item">
                    <a href="https://github.com/jackyliu1999/Bitcoin-Price-Notifier"> <img src={GitLogo} alt="" /></a>
                            &nbsp; <img src={infoIcon} onClick={handleshow8Show} alt="" />
                    <a href="https://github.com/jackyliu1999/Bitcoin-Price-Notifier"><h4 style={{ color: "#e6f1ff" }}>Bitcoin Price Notifier</h4></a>
                    <p style={{ color: "white" }}>Notifies users of Bitcoin price fluctuation by extracting the live price of Bitcoin from Yahoo Finance. Allows users to set a benchmark and once the price hits the designated benchmark, verbally notifies user.</p>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="projects2__item">
                    <a href="https://github.com/jackyliu1999/Notes-to-Text-Converter"> <img src={GitLogo} alt="" /></a>
                            &nbsp; <img src={infoIcon} onClick={handleshow2Show} alt="" />
                    <a href="https://github.com/jackyliu1999/Notes-to-Text-Converter"><h4 style={{ color: "#e6f1ff" }}>Notes to Text Converter</h4></a>
                    <p style={{ color: "white" }}>Takes handwritten notes and converts them into text. Incorporates optical character recognition tool, pytesseract for the conversion functionality. Tkinter was utilized in order to provide a user-friendly interface.</p>
                  </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                  <div class="projects2__item">
      ...
      <footer id="footer">
        <div class="container">
          <div class="copyright">
            &copy; Copyright <strong><span>Jacky Liu</span></strong>. All Rights Reserved
      </div>
          <div class="credits">
            Designed by Jacky Liu
      </div>
        </div>
      </footer>
